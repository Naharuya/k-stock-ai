...
export async function analyzeMarketContext() {
  ...
  const kospiChart = await getDomesticIndexDailyChart({ indexCode: "0001", minRows: 130, maxPages: 4 });
  const kosdaqChart = await getDomesticIndexDailyChart({ indexCode: "1001", minRows: 130, maxPages: 4 });
