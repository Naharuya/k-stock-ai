...
const checks = {
  ...
  analyzeUsesCode: js.includes('selectedStockCode=b.dataset.code') && js.includes('analyze({focusDetail:true})'),
...
console.log(JSON.stringify({ ok, version: "2.6.0", checks }, null, 2));
